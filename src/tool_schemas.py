        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "model": {"type": "string", "description": "Optional. Valid values ONLY: 'opus', 'sonnet', 'haiku', or a full id like 'claude-opus-5' / 'claude-sonnet-5' / 'claude-haiku-4-5-20251001'. Never invent an id such as 'claude-opus-4' — the run fails outright. Omit this to use the CLI's own default, which is the safe choice when the user has not named a model."},
